...
\include {chap/platforma}

\include {chap/funkcjonalnosci}

\include{chap/projekt}

\include{chap/dodatek-vivado}

\include{chap/podsumowanie}
...
\input {chap/dodatek-cd}

\include {chap/dodatek-neon}

\include {chap/dodatek-vdma-to-cv}
